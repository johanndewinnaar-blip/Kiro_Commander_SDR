...
| T2 Real API TEST MODE design | Define test tenants and vendor test environments. | TEST MODE checklist, credential plan, read-only policy. |
...
| Week 3 | Limited TEST MODE pull tests for approved read-only APIs. | Data conformance review. |
