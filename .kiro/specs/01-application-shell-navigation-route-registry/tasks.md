# Tasks — Application Shell, Navigation and Route Registry
...
- [x] 2.1 Map domain routes, pages, panels or APIs to future folders: `docs/06_ui_build_reference`.
...
- [x] 3.1 Create implementation files only after owner approval.
- [x] 3.2 Add tests before or with implementation.
- [x] 3.3 Update route registry, feature flags and build status.
