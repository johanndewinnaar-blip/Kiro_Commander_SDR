...
- [ ] 3.1 Create implementation files only after owner approval. **[BLOCKED — awaiting pack validation]**
- [ ] 3.2 Add tests before or with implementation. **[BLOCKED — awaiting pack validation]**
- [ ] 3.3 Update route registry, feature flags and build status. **[BLOCKED — awaiting pack validation]**
