          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: primitiveTypeScale.caption }}>
            ...
            <tbody>{exceptions.length === 0 ? (
              ...
              <tr key={e.id} style={{ borderBottom: `1px solid ${tokens.border.subtle}` }}>
                ...
                <td style={{ padding: `${primitiveSpacing[2]} ${primitiveSpacing[3]}` }}><span style={{ padding: '2px 8px', fontSize: primitiveTypeScale.micro, fontWeight: primitiveFontWeight.semibold, color: '#fff', background: primitiveSignal.warning }}>{e.exceptionState.replace(/_/g, ' ')}</span></td>
