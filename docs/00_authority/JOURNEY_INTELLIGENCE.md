...
**Decision:** DEC-journey-intelligence-foundation (DECISIONS.md)
**Proposition Evolution:** EVO-011 (PROPOSITION_EVOLUTION.md)
...
### Enrichment & Evaluation Journeys (3)
...
### Strategic & Operational Journeys (5)
...
- **Applies To:** All case templates (JT-CASE-*), action templates (JT-ACT-*)
...
- **Impact Output:** impactClassification (high_positive/moderate_positive/neutral/negative), riskDelta, exposureDelta, controlImprovement, timeSavedHours, effortSavedHours
...
- **Applies To:** All templates (most valuable for case and action templates)
...
- **Applies To:** JT-ACT-*, JT-CASE-* where delivery_mode includes automation
...
2. OodaStage, DeliveryMode, LifecycleCheckpoint, JourneyStatus, JourneyOutcome, JourneyAnchorType enums
...
- `.kiro/steering/` (when steering file is created)
- Future Kiro spec for Journey Intelligence implementation
- Future build pack for Journey Intelligence
