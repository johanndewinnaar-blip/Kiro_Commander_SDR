# BP-16 — Email Case Communication
...
Deliver the Commander SDR work slice for **Email Case Communication** while preserving no-MVP full-journey doctrine.
...
- `.kiro/specs/25-email-case-communication`
