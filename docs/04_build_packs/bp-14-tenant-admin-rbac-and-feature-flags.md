# BP-14 — Tenant Admin, RBAC and Feature Flags
...
Deliver the Commander SDR work slice for **Tenant Admin, RBAC and Feature Flags** while preserving no-MVP full-journey doctrine.
...
- `.kiro/specs/18-tenant-admin`
- `.kiro/specs/19-rbac-entitlement-feature-flags`
