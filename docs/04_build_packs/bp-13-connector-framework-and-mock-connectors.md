# BP-13 — Connector Framework and Mock Connectors
...
Deliver the Commander SDR work slice for **Connector Framework and Mock Connectors** while preserving no-MVP full-journey doctrine.
...
- `.kiro/specs/16-connector-framework`
- `.kiro/specs/17-mock-connectors`
