# BP-12 — Governance, Reporting and CISO Dashboard
...
Deliver the Commander SDR work slice for **Governance, Reporting and CISO Dashboard** while preserving no-MVP full-journey doctrine.
...
- `.kiro/specs/22-governance-reporting`
- `.kiro/specs/23-ciso-dashboard`
