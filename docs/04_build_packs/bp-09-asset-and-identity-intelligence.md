# BP-09 — Asset and Identity Intelligence
...
Deliver the Commander SDR work slice for **Asset and Identity Intelligence** while preserving no-MVP full-journey doctrine.
...
- `.kiro/specs/09-asset-intelligence`
- `.kiro/specs/10-identity-intelligence`
