# BP-10 — Control Coverage and Editable Baselines
...
Deliver the Commander SDR work slice for **Control Coverage and Editable Baselines** while preserving no-MVP full-journey doctrine.
...
- `.kiro/specs/11-control-coverage-editable-baselines`
