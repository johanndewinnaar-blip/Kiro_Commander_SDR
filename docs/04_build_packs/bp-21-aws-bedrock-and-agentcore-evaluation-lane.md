# BP-21 — AWS Bedrock and AgentCore Evaluation Lane
...
Deliver the Commander SDR work slice for **AWS Bedrock and AgentCore Evaluation Lane** while preserving no-MVP full-journey doctrine.
...
- `.kiro/specs/21-aws-bedrock-agentcore-evaluation`
- `.kiro/specs/31-devops-local-aws-alignment`
