# BP-11 — Architecture and Topology
...
Deliver the Commander SDR work slice for **Architecture and Topology** while preserving no-MVP full-journey doctrine.
...
- `.kiro/specs/12-architecture-topology`
