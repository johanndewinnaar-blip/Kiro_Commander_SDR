# BP-05 — Case Management Core Lifecycle
...
Deliver the Commander SDR work slice for **Case Management Core Lifecycle** while preserving no-MVP full-journey doctrine.
