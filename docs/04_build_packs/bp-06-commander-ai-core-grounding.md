# BP-06 — Commander AI Core Grounding
...
Deliver the Commander SDR work slice for **Commander AI Core Grounding** while preserving no-MVP full-journey doctrine.
...
- `.kiro/specs/20-commander-ai-core`
