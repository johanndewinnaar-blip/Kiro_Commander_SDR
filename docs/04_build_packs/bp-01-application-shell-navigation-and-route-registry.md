...
Deliver the Commander SDR work slice for **Application Shell, Navigation and Route Registry** while preserving no-MVP full-journey doctrine.
...
- `.kiro/specs/01-application-shell-navigation-route-registry`
